...
public class ButtonActions : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Construye la lista de parámetros para facilitar su manejo
        ...
        {
            Debug.LogWarning("ButtonActions: 'fighterSprite' no tiene SpriteRenderer asignado o no se encontró.");
        }
    }
